...
#define SPR_DMMUTEIR	(SPRGROUP_DMMU + 2)
...
#define SPR_IMMUTEIR	(SPRGROUP_IMMU + 2)
#define SPR_ITLBMR_BASE(WAY)	(SPRGROUP_IMMU + 0x200 + (WAY) * 0x100)
#define SPR_ITLBMR_LAST(WAY)	(SPRGROUP_IMMU + 0x27f + (WAY) * 0x100)
#define SPR_ITLBTR_BASE(WAY)	(SPRGROUP_IMMU + 0x280 + (WAY) * 0x100)
#define SPR_ITLBTR_LAST(WAY)	(SPRGROUP_IMMU + 0x2ff + (WAY) * 0x100)

/* revision 3, version 1220 and newer TLB registers */
#define SPR_DTLBEIR     (SPRGROUP_DMMU + 2)
#define SPR_DTLBMR      (SPRGROUP_DMMU + 4)
#define SPR_DTLBTR      (SPRGROUP_DMMU + 6)

#define SPR_ITLBEIR     (SPRGROUP_IMMU + 2)
#define SPR_ITLBMR      (SPRGROUP_IMMU + 4)
#define SPR_ITLBTR      (SPRGROUP_IMMU + 6)
...
#define SPR_PM_EVENT_CTRL (SPRGROUP_PM + 0)
#define SPR_PM_UNITS_PD   (SPRGROUP_PM + 2)
...
#define SPR_CPUCFGR_CFG		0x00000010 /* Custom GPR file */
