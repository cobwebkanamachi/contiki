...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>2.3996359683956725</x>
        <y>46.46121659655349</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>-6.274953046399992</x>
        <y>100.09252308569442</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>28.30046177622445</x>
        <y>170.60655408925004</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>39.018044869119116</x>
        <y>-1.767907321472508</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.119655420069057 0.0 0.0 1.119655420069057 245.31323458179313 33.979447014666455</viewport>
      <hidden />
    </plugin_config>
    <width>400</width>
    <z>0</z>
  ...
  <plugin>
    ...
    <plugin_config>
      <filter>drift recorded|Reply</filter>
      <formatted_time />
      <coloring />
    </plugin_config>
    <width>621</width>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <showRadioHW />
      <showLEDs />
      <zoomfactor>250.36640502020998</zoomfactor>
    </plugin_config>
    <width>1659</width>
    <z>2</z>
    <height>240</height>
