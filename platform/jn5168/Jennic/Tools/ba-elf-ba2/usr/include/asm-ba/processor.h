...
#  define KERNEL_SR (SPR_SR_DME | SPR_SR_IME | SPR_SR_ICE              | SPR_SR_SM)
#  define USER_SR   (SPR_SR_DME | SPR_SR_IME | SPR_SR_ICE              | SPR_SR_IEE | SPR_SR_TEE)
#elif defined(CONFIG_OR32_DCACHE_ENABLED) && !defined(CONFIG_OR32_ICACHE_ENABLED)
#  define KERNEL_SR (SPR_SR_DME | SPR_SR_IME              | SPR_SR_DCE | SPR_SR_SM)
#  define USER_SR   (SPR_SR_DME | SPR_SR_IME              | SPR_SR_DCE | SPR_SR_IEE | SPR_SR_TEE)
#else
#  define KERNEL_SR (SPR_SR_DME | SPR_SR_IME                           | SPR_SR_SM)
#  define USER_SR   (SPR_SR_DME | SPR_SR_IME                           | SPR_SR_IEE | SPR_SR_TEE)
#endif
