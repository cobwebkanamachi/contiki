/* $Revision: 1.1 $$Date: 2008/02/15 15:08:00 $
 ...
 *$Log: cyclades.h,v $
 *Revision 1.1  2008/02/15 15:08:00  dcook
 *Baseline for ba2 tool chain.  ba-elf tool chain is backwards comatible with ba1 tool chain.  Use this for all JN514x development.
 *
 *Check out to C:\Jennic\cygwin\
 *
 *o	Compiler: 		Osmion ba-elf-gcc v 4.1.2 (ba2)
 *o	Assembler:		2.17
 *o	Linker:			2.17
 *o	Debugger:		gdb v 6.6
 *
 *Build ??
 *
