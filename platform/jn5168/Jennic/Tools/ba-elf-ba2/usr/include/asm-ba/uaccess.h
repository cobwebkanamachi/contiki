...
extern unsigned long __copy_from_user(void *to, const void *from, unsigned long size);
extern unsigned long __copy_to_user(void *to, const void *from, unsigned long size);
...
copy_from_user(void *to, const void *from, unsigned long n)
{
	...
	if ((unsigned long)from < TASK_SIZE) {
		...
		return __copy_from_user(to, from, n - over) + over;
	}
	return n;
}
...
copy_to_user(void *to, const void *from, unsigned long n)
{
	...
	if ((unsigned long)to < TASK_SIZE) {
		...
		return __copy_to_user(to, from, n - over) + over;
	}
	return n;
}
